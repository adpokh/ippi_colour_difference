...
log_dir = os.path.join("runs_lab", datetime.now().strftime("%Y%m%d-%H%M%S"))
...
print(f"Number of polynomial features: {features_poly.shape[1]}")

features = torch.tensor(features_poly, dtype=torch.float32)
...
# Сохраняем модель
model_path = "colour_net_model_lab_2.pth"
torch.save({
